...
function displayPics() {
  ...
  // the scope change from globle(var) to local(let) and since  the variable rando declered the first while loop and called out of it . that will make it un declered.
  console.log(viewed);
